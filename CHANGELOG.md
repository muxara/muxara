...
- Session discovery failed on Spotlight/Dock launch — tmux outputs literal `\t` instead of tab characters when the process environment lacks shell setup; switched to `|||` delimiter that works regardless of environment

## [0.1.4] - 2026-05-20

### Fixed

- Session discovery broken in signed release builds due to Tauri crate version bump in v0.1.3; pinned dependencies to known-good versions

## [0.1.3] - 2026-05-20

### Added

- Configurable scrollback lines setting (default 50,000 lines)
- Automatic mouse mode on discovered tmux sessions for scroll support

### Fixed

- Tmux socket path now works even when the tmux server hasn't started yet — previously Muxara could not create sessions if launched before tmux

## [0.1.2] - 2026-04-22

### Fixed

- Installed app could not discover existing tmux sessions — macOS apps launched from Spotlight/Dock get a different TMPDIR, so tmux connected to the wrong socket; now explicitly targets the canonical socket path
...
[Unreleased]: https://github.com/muxara/muxara/compare/v0.1.5...HEAD
[0.1.5]: https://github.com/muxara/muxara/compare/v0.1.4...v0.1.5
[0.1.4]: https://github.com/muxara/muxara/compare/v0.1.3...v0.1.4
[0.1.3]: https://github.com/muxara/muxara/compare/v0.1.2...v0.1.3
[0.1.2]: https://github.com/muxara/muxara/compare/v0.1.1...v0.1.2
